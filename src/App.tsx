...
function App() {
  return (
    <>
      <meta property="og:title" content="Keebstagram YSWS!" />
      <meta
        property="og:description"
        content="Make keyboard related projects. Get exclusive Hack Club keyboard merch, and a mechanical keyboard. 100% free."
      />
      <meta property="og:image" content="https://yourwebsite.com/banner.png" />
      <meta property="og:url" content="https://keebstagram.octotwelve.xyz" />
      ...
      <div className="w-full flex flex-col gap-2">
        ...
        <div className="flex flex-col gap-8 md:px-24 px-12 py-18 text-center items-center justify-center">
          <div className="flex flex-col gap-4">
            ...
            <p className="text-3xl">
              Then show it off on your virtual keyboard! Everyone gets to see
              your shared project!
            </p>
          </div>
        ...
        <div className="flex flex-col gap-12 md:px-24 px-12 py-18 text-center items-center justify-center">
          <div className="flex flex-col gap-4">
            ...
            <p className="text-2xl">
              ROYAL KLUDGE R65 or similar 60-65% keyboard. That means 16 hours
              of coding!
            </p>
          </div>
          <div className="relative">
        ...
        <div className="flex flex-col gap-12 md:px-24 px-12 py-18 text-center items-center justify-center">
          <div className="flex flex-col gap-4">
            <b className="text-4xl">
              ...
              keyboard, AND a Hack Club-themed mouse pad, and 5 total custom
              keys.
            </b>
            <p className="text-2xl">
        ...
        <div className="flex flex-col gap-12 md:px-24 px-12 py-18 text-center items-center justify-center">
          <div className="flex flex-col gap-4">
            ...
            <p className="text-2xl">
              ROYAL KLUDGE S98, or similar 96%-100% keyboard, and a bigger
              version of the exclusive desk pad above! That means 26 hours of
              coding!
            </p>
          </div>
          ...
          <p className="text-xl">
            Want a different keyboard? We'll have alternate keyboards avaliable
            in the shop!
          </p>
        </div>
          ...
          <div className="h">
            ...
            >
              ...
              <div className="flex flex-col gap-2 flex-1">
                ...
                <p className="text-4xl">
                  Add fun colors and deskpads! If you claimed custom keycaps,
        ...
        <div className="flex flex-col gap-4 md:px-24 px-12 py-18">
          ...
          <Collapsible title="Can I choose a different keyboard?">
            <p>
              Yes! There will be alternative keyboards as listed on the shop.
              Once you complete each of the 3 tiers, you'll be able to select
              the keyboards you want of that form factor.
            </p>
          </Collapsible>
        </div>
        <div className="flex flex-col gap-4 md:px-24 px-12 py-18">
          ...
          <Collapsible title="What's the 'YS' part of this event?">
            <p>
              This is designed to be a keyboard-themed YSWS where you can ship
              any keyboard related project. This way, you can make many projects
              with fewer hours to work up towards a goal, or make one project
              with many hours. I chose this flexibility as I found in my
              personal experience doing YSWS events, that it got tiring doing 1
              singular project for many hours.
            </p>
          </Collapsible>
          ...
          <Collapsible title="Why the 3 tiers of keyboards?">
            <p>
              ...
              advance, you're encouraged to spend more time making projects to
              get that merch as well!
            </p>
          </Collapsible>
        </div>
